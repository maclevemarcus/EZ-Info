...
public class AnnouncementListFragment extends Fragment implements View.OnClickListener{
    ...
    private List<Announcement> mAnnounceList;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = view.findViewById(R.id.rvAnnounce);
        ...
        mDatabase.child("Announcement").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAnnounceList = new ArrayList<>();
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    Announcement post = postSnapshot.getValue(Announcement.class);
                    mAnnounceList.add(post);
                }
                //creating adapter
                mAdapter = new AnnouncementAdapter(context, mAnnounceList);
    ...
    public void onClick(View v) {
        ...
        if( v == mAddEventBtn){
            fragment = new AddAnnouncementFragment();
